import { BQBTCTokenContract, BQTokenContract } from '@/constant/contracts';
...
export const useAddToken = () => {
  ...
  const checkAndAddToken = async () => {
    const tokenAddress =
      BQBTCTokenContract.addresses[(chain as ChainType)?.chainNickName]; // Replace with your token contract address
